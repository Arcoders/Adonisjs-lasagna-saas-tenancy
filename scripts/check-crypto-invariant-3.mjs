...
//
// I3: "Reads fail closed; writes reject cleartext
...
//           decryptModelFields, then EncryptedRepository.decrypt, then CryptoService.decryptField,
...
//           src", which one method could not enforce.
//
