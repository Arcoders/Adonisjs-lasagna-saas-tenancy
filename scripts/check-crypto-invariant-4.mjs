...
//
// I4: "Each (subject x category) derives its own
// DEK, and each secret class its own HKDF context; keys never overlap". This is the
...
//
//   DERIVED KEYS: domain-separated by DISTINCT frozen HKDF salts and a category-bound
