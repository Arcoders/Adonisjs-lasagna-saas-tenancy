...
[Stability](/docs/stability); for the things that are intentionally out of
scope, see [Known limitations](/docs/known-limitations).
...
[release notes](/docs/release-notes) before upgrading.
