...
|---|---|---|---|
| [reporting](/docs/satellites/reporting) | custom reports | `ReportExtensionRegistry` | `REPORTING_CONTRACT_VERSION` |
| [billing](/docs/satellites/billing) | payment drivers | `BillingDriverRegistry` | `BILLING_CONTRACT_VERSION` |
| [websockets](/docs/satellites/websockets) | authorize hook | config `authorize` | `WEBSOCKETS_CONTRACT_VERSION` |
| [admin](/docs/satellites/admin) | custom actions | `adminActionRegistry` | `ADMIN_CONTRACT_VERSION` |
| [sso](/docs/satellites/sso) | identity providers | `identityProviderRegistry` | `SSO_CONTRACT_VERSION` |
| [audit](/docs/satellites/audit) | log destinations | `AuditLogDestinationRegistry` | `AUDIT_CONTRACT_VERSION` |
| [feature-flags](/docs/satellites/feature-flags) | evaluation strategies | `EvaluationStrategyRegistry` | `FEATURE_FLAGS_CONTRACT_VERSION` |
| [webhooks](/docs/satellites/webhooks) | payload transformers | `WebhookTransformerRegistry` | `WEBHOOKS_CONTRACT_VERSION` |
