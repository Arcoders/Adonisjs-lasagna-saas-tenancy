...
([Broadcasting](/docs/bootstrappers/broadcasting), via `tenantBroadcast`). This
...
test), see the [Multi-tenant WebSockets cookbook](/docs/cookbook/multi-tenant-websockets).

> Use [Broadcasting](/docs/bootstrappers/broadcasting) when one-way push is
