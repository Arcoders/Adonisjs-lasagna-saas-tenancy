...
[`tests/unit/services/tenant_log_context.spec.ts`](https://github.com/Arcoders/Adonisjs-lasagna-saas-tenancy/blob/master/tests/unit/services/tenant_log_context.spec.ts)
