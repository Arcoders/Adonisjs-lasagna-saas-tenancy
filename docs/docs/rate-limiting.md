...
more than abuse protection on that path. See [Resilience](/docs/resilience).
...
- [Quotas](/docs/satellites/quotas) — rolling-day usage counters (a separate
  system from request-rate limiting).
- [Resilience](/docs/resilience) — fail-open vs fail-closed policy.
