...
[backup satellite](/guides/satellites/), and three with the
[Billing satellite](/guides/satellites/billing).
...
[Lifecycle events](/reference/events) for payloads.
...
- [Lifecycle events](/reference/events); what each job emits on success
- [Commands](/reference/commands); ace wrappers that dispatch these jobs
- [Contextual logging](/guides/contextual-logging); how the tenant id
