...
checklist; Crypto is the field-level encryption mechanism
(`@adonisjs-lasagna/crypto`), the keystone of the data-protection satellites. They
live here because that's where you'll look for them.
</Callout>
