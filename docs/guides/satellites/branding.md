...
[mail bootstrapper](/guides/bootstrappers/mail).
...
[tenant identification](/guides/tenant-identification).
...
- [Admin REST API](/guides/satellites/admin-rest-api); managing branding over HTTP.
