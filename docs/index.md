...
hero:
  name: Lasagna
  text: Production multi-tenancy for AdonisJS
  tagline: "Every tenant isolated in its own PostgreSQL schema, with the plumbing a real SaaS needs: routing, queues, quotas, backups, replicas, SSO, and billing. One package."
  actions:
    - theme: brand
      text: Quickstart
      link: /quickstart
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/Arcoders/Adonisjs-lasagna-saas-tenancy
