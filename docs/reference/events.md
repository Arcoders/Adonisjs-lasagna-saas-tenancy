...
[Deployment](/guides/deployment#dependency-outages-fail-closed)). The
...
[Resilience](/guides/resilience) page.
...
- [Jobs](/guides/jobs); most events are dispatched from inside a job
- [Quotas](/guides/satellites/quotas); source of `TenantQuotaExceeded`
- [Contextual logging](/guides/contextual-logging); listener log lines
