...
// The two-phase WORM-audit half of the interlock (the legal-hold and
// governance-absent halves live in their own design-named specs,
// security_shred_legal_hold_refused and security_shred_governance_absent_refused). An
...
test.group('crypto shred: fail-closed two-phase audit', (group) => {
  group.each.setup(() => {
