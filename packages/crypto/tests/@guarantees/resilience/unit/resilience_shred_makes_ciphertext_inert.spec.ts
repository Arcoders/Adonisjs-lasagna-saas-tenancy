...
// I6 (§6.6): crypto-shred destroys the ONLY copy of a (subject × category) DEK,
...
test.group('crypto shred — makes ciphertext inert (I6)', (group) => {
  group.each.setup(() => {
  ...
  test('a re-provision after a shred inserts a fresh live DEK (§6.3, I10)', async ({ assert }) => {
