...
import type WormLedgerWriter from '@adonisjs-lasagna/saas-tenancy/worm-ledger'
 ...
 * hashed before it reaches the ledger, so the ledger stays non-PII (the WORM <->
 * shred reconciliation: keeping it forever leaks nothing).
 *
 ...
 * from the narrow `@adonisjs-lasagna/saas-tenancy/worm-ledger` subpath.
 */
