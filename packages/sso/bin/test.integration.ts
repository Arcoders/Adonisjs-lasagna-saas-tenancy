...
// provider, so the unified adapter that routes TenantSsoConfig (a
// BackofficeBaseModel) to the backoffice schema is wired, plus a real PG/Redis).
// sso ships only a backstop provider (it asserts ABI + plugin-API
