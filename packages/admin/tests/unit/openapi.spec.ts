 ...
 * publishes independently via Changesets. Mirrors the same assertions core
 * runs against this surface, but from the admin package's own cwd so a broken
 * build or OpenAPI document fails admin's CI in isolation. Imports
 * `src/openapi.js` directly (NOT the `index.js` barrel, which re-exports
