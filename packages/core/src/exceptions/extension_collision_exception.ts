 ...
 * silently shadow the first registration and re-point behavior with no signal —
 * resolved by renaming or removing one, not last-writer-wins. The `plugin`
 * attribution carries the colliding entry's name.
 *
