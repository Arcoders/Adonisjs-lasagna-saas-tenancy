 ...
 *
 * Why independent (plan R5#5, reversing the round-1 alias): the facade can evolve
 ...
 * plugin needing a NEWER facade than this core provides `fail`s (throws, aborting
