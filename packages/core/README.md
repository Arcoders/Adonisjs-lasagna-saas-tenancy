...
flags, metrics, and multi-provider billing (Stripe, Paddle, Lemon Squeezy).
...
[examples/api/](https://github.com/Arcoders/Adonisjs-lasagna-saas-tenancy/tree/master/examples/api). It's a real AdonisJS 7 app that
...
[`examples/api/`](https://github.com/Arcoders/Adonisjs-lasagna-saas-tenancy/tree/master/examples/api) is a real AdonisJS 7 app that wires
