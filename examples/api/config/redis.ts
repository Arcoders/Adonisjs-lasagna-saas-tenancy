...
// REDIS_PASSWORD is optional (local Redis usually runs open). Spread the key in
// only when it is set, rather than passing `undefined`, which
// exactOptionalPropertyTypes rejects against ioredis' `password?: string`.
