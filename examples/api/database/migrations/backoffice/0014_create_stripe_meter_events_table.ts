 ...
 * `stripe.billing.meterEvents.create` call. `idempotency_key` is unique at the
 * DB layer (defense in depth) and sent to Stripe as `Idempotency-Key`.
 */
export default class extends BaseSchema {
  protected tableName = 'stripe_meter_events'
