...
/**
 * Canonical `TenantRepositoryContract` implementation, copied in shape from the
 * core test fixture. The package never imports the host's Tenant model; it
 * resolves tenants through this binding.
 */
