...
/**
 * The operator realm's login surface. Mounted under `router.central()`:
 * operators authenticate on the apex, never inside a company context. The
 * minted `bko_` token is what the admin API, `/metrics` and the reporting
 * dashboard expect as a bearer.
 */
